...
class ReplyService:
    ...
    def _get_interest_signal_reply(self, language: str) -> str:
        if language == "uk":
            return (
                "Супер. Чи актуально розглянути впровадження такого бота для вашого бізнесу "
                "чи поки просто придивляєтесь?"
            )
        return (
            "Супер. Чи актуально розглянути впровадження такого бота для вашого бізнесу "
            "чи поки просто придивляєтесь?"
    ...
    def _get_service_description_fallback_reply(
        ...
        standard_description = (
            ...
            "Чи актуально розглянути впровадження такого бота для вашого бізнесу?"
        )
